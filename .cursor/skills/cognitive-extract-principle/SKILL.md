...
| **D4 运行时数据** | `cognitive/L2_fragments/fragment_index.md` | 所有🔲待整合碎片（提炼原则的原材料）|
...
```
Step 1  读取碎片数据
        Read: cognitive/L2_fragments/fragment_index.md（全部条目）
...
Step 5  [L1约束检查] 新原则对现有L1文档的影响（CS-003 + E1C 修复）
        ...
        a. 【强制】Write: 追加到 cognitive/L3_logs/todo.md：
           ```
...
- 修改：Step 5 → 在检查清单生成后，【强制】追加到 cognitive/L3_logs/todo.md（E1C）
