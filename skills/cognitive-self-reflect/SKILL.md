...
```
Step 1  读取历史反思记录
        Read: cognitive/L2_fragments/reflections/reflections.md
...
Step 3  历史模式比对 + 反刍检测（苏格拉底模式）
        ...
        IF 用户选「转化为待完成事项」→ 直接写入 cognitive/L3_logs/todo.md，跳出反思流程
...
- 行动优先原则：选择「转化为待完成事项」时直接写入cognitive/L3_logs/todo.md
